...
## Цель
1.Ознакомится с уязвимостью типа **Insecure Direct Object Reference(IDOR)**.
...
2.Получить флаг для прохождения комнаты.
